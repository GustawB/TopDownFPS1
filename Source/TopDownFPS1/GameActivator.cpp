...
#include "GameActivator.h"

// Sets default values
AGameActivator::AGameActivator()
{
	...
	isAnyGameActivated = false;
	isLimitedGameActivated = false;
	isTimeGameActivated = false;
}

// Called when the game starts or when spawned
void AGameActivator::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AGameActivator::Tick(float DeltaTime)
{
